(() => {
        ...
        if (services && window.matchMedia("(min-width: 993px)").matches) {
            ...
            btnServices.addEventListener("click", (() => {
                if (!services.classList.contains("open")) {
                    ...
                    document.body.classList.add("body-hidden");
                    if (window.matchMedia("(min-width: 993px)").matches) header.classList.add("active");
            ...
            function closeServices() {
                ...
                document.body.classList.remove("body-hidden");
                if (window.scrollY < header.clientHeight) header.classList.remove("active");
    ...
    function headerScroll() {
        ...
        if (header) {
            ...
            function scrolling() {
                if (window.scrollY > header.clientHeight) header.classList.add("active"); else header.classList.remove("active");
            }
        }
    }
    function tab() {
        ...
        if (buttonsSelect.length) {
            buttonsSelect.forEach((btn => {
                btn.addEventListener("click", (e => {
                    ...
                    if (currentSelect.classList.contains("open")) closeSelect(); else {
